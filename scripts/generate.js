...
/**
 * @typdef {Object} Theme - Parsed theme object.
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} nyx - Nyx color variables.
 * @prop {Record<string, string|null|undefined} colors - VSCode color mapping.
 * @prop {TokenColor[]} tokenColors - Textmate token colors.
 */

/**
 * @typdef {(yamlObj: Theme) => Theme} ThemeTransform
 */
